...
import cf.coiltech.com.stok.adapter.ContactsAdapter;
import cf.coiltech.com.stok.network.ApiClient;
import cf.coiltech.com.stok.network.ApiService;
...
public class RemoteSearchActivity extends AppCompatActivity implements ContactsAdapter.ContactsAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        anaSayfaButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(RemoteSearchActivity.this, AnaSayfa.class);
        ...
        sayimYapButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RemoteSearchActivity.this, SayimActivity.class);
                startActivityForResult(intent, RESULT_OK);
            }
        });
        ...
        cikisYapButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RemoteSearchActivity.this, CikisYapActivity.class);
                startActivityForResult(intent, RESULT_OK);
            }
        });
    ...
    private DisposableObserver<TextViewTextChangeEvent> searchContactsTextWatcher() {
        return new DisposableObserver<TextViewTextChangeEvent>() {
            ...
            public void onNext(TextViewTextChangeEvent textViewTextChangeEvent) {
                //searh text length character count for query
    ...
    public void onContactSelected(Contact contact) {
        ...
        //Toast.makeText(this, contact.getID().toString(), Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(getApplicationContext(), UrunDetayActivity.class);
        intent.putExtra("urunID", contact.getID().toString());
